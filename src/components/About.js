...
function About() {
    ...
    return(
        <section id="about">
            ...
            <p>An enthusiastic and dedicated Software Developer with excellent interpersonal and problem-solving skills as well as great analytic and planning ability. 
